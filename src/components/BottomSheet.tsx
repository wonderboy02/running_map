    ...
    <Sheet isOpen={!!spot} onClose={onClose}>
      <Sheet.Container style={{ maxHeight: '75vh' }}>
        ...
        <Sheet.Content>
          ...
          <button
            onClick={onClose}
            className="absolute top-3 right-3 z-20 p-1.5 rounded-full bg-white/90 backdrop-blur-sm shadow-sm hover:bg-white transition-colors"
            aria-label="닫기"
          >
          ...
          {isRunnerSpot && hasPhotos ? (
            ...
            <div className="relative h-32 bg-gray-100 flex items-center justify-center -mx-4 -mt-4">
